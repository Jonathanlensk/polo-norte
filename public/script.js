...
function icon(nome, tamanho = 18) {
    ...
    return `<svg class="icon"
        ...
        stroke-linejoin="round">${conteudo}</svg>`;
}
...
function adicionar(id) {
    if (!estado.carrinho[id]) {
        estado.carrinho[id] = 0;
    }
    ...
    fetch(`https://viacep.com.br/ws/${cep}/json/`)
        ...
        .then(dados => {
            ...
            if (dados.erro) {
                ...
                estado.endereco.rua =
                    dados.logradouro || estado.endereco.rua;

                estado.endereco.bairro =
                    dados.bairro || estado.endereco.bairro;
...
async function processarPagamento(metodo, dadosCartao = null) {
    ...
    try {
        const payload = {
            ...
            /* GARANTE FRETE ZERO ENVIADO AO BACKEND */
            taxaEntrega: 0,
            frete: 0
        };
    ...
    return `
        ...
        <main class="container confirmacao">
            ...
            <p class="subtitulo">
                ...
                Pague pelo QR Code ou use o Pix Copia e Cola.
            </p>
            ...
            <button
                class="botao-principal"
                onclick="verificarPedido('${pix.mercadoPagoOrderId || ""}')"
            >
                Verificar pagamento
                ${icon("seta", 16)}
            </button>
...
function header(voltar = null) {
    return `
        <header class="header">
            ...
            <button
                class="header-btn"
                onclick="${voltar ? `ir('${voltar}')` : "emBreve()"}"
            >
            ...
            >
                ...
                ${quantidadeCarrinho() > 0
                    ? `<span class="badge">${quantidadeCarrinho()}</span>`
                    : ""
                }
            </button>
        ...
        <main class="container">
            ...
            <div class="loja-header">
                ...
                <div class="loja-header-info">
                    ...
                    <span class="status">
                        ● Aberto até 00:00 · Entrega grátis
                    </span>
                </div>
                ...
                ${categorias.map(categoria => `
                    ...
                    >
                        ...
                        <span class="categoria-icone">
                            ${icon(categoriasInfo[categoria].icone, 20)}
                        </span>
                        ...
                        <article class="produto">
                            ...
                            ${produto.precoOriginal
                                ? `<span class="badge-desconto">
                                    -${Math.round(
                                        (1 - produto.preco / produto.precoOriginal) * 100
                                    )}%
                                   </span>`
                                : ""
                            }
                            ...
                            <button
                                class="favorito
                                ${estado.favoritos.has(produto.id) ? "ativo" : ""}"
                                onclick="
                                    alternarFavorito(
                                        event,
                                        ${produto.id}
                            ...
                            <div
                                class="produto-img
                                ${classeCategoria(produto.categoria)}"
                            >
                                ${produto.emoji}
                            </div>
        ...
        <main class="container">
            ...
            <div class="carrinho-topo">
                ...
                ${itens.length > 0 ? `
                    <button
                        ...
                        onclick="estado.carrinho={}; render()"
                    >
                        ${icon("lixo", 14)}
                        Limpar carrinho
                    </button>
            ...
            ${itens.length > 0 ? `
                ...
                <div class="resumo">
                    ...
                    <div class="linha">
                        <span>
                            Subtotal (${quantidadeCarrinho()} itens)
                        </span>
